...
- Immediately before charging the customer, the tenant should call [Verify Prices](/docs/reference/essential-api-calls#63-verify-prices) to confirm that the cart prices still match Arcube's authoritative bundle and re-confirm with the user if any item has drifted.
...
→ Refer to [Confirm Order](/docs/reference/essential-api-calls#64-confirm-order) for details on how to complete this step.
