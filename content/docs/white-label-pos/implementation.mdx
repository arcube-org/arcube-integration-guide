...
- Before charging, the white-label site calls [Verify Prices](/docs/reference/essential-api-calls#63-verify-prices) to confirm the cart still matches the authoritative bundle - the passenger sees the updated total if any item has drifted
